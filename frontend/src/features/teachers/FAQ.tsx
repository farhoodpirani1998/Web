 ...
 * (now a third identical instance of the pattern) to a shared
 * `Accordion` primitive is a natural follow-up.
 *
 * Items are grouped into a local array literal rather than
 * interleaved in JSX, so swapping this for a `useTeachers()`-style
 * data hook later is a matter of replacing the literal. Real
 * questions/answers are ultimately Teachers content-module data
...
const faqItems = [
  {
    id: "selection",
    question: "مدرسان مجموعه چگونه انتخاب می‌شوند؟",
    answer: "متن نمونه پاسخ درباره فرآیند گزینش و ارزیابی مدرسان.",
  },
  {
    id: "credentials",
    question: "مدرسان چه مدارک و سوابقی دارند؟",
    answer: "متن نمونه پاسخ درباره مدارک تحصیلی و سوابق تدریس مدرسان.",
  },
  {
    id: "contact-teacher",
    question: "چگونه می‌توان با یک مدرس خاص در تماس بود؟",
    answer: "متن نمونه پاسخ درباره روش هماهنگی و تماس با مدرسان.",
  },
  {
    id: "change-teacher",
    question: "آیا امکان تغییر مدرس برای یک دانش‌آموز وجود دارد؟",
    answer: "متن نمونه پاسخ درباره فرآیند درخواست تغییر مدرس.",
  },
] as const;
...
export function FAQ() {
  ...
  return (
    <Section spacing="lg" aria-labelledby="teachers-faq-heading">
      <Stack gap="lg">
        <Stack gap="sm" align="center" className="text-center">
          <Heading id="teachers-faq-heading" level={2}>
            سوالات متداول
          </Heading>
          <Text variant="lead" className="max-w-2xl">
            متن معرفی نمونه برای بخش سوالات متداول کادر آموزشی.
          </Text>
        </Stack>
